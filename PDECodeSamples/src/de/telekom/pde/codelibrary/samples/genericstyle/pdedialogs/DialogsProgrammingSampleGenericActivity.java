...
public class DialogsProgrammingSampleGenericActivity extends PDEActionBarActivity {
    ...
    // buttons
    PDEButton mDefaultButton1, mDefaultButton2, mDefaultButton3;
    PDEButton mCustomButton1, mCustomButton2, mCustomButton3;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mDefaultButton1.addListener(this, "onClickButton", PDEAgentController.PDE_AGENT_CONTROLLER_EVENT_ACTION_SELECTED);
        mDefaultButton2.addListener(this, "onClickButton", PDEAgentController.PDE_AGENT_CONTROLLER_EVENT_ACTION_SELECTED);
        mDefaultButton3.addListener(this, "onClickButton", PDEAgentController.PDE_AGENT_CONTROLLER_EVENT_ACTION_SELECTED);
        mCustomButton1.addListener(this, "onClickButton", PDEAgentController.PDE_AGENT_CONTROLLER_EVENT_ACTION_SELECTED);
        mCustomButton2.addListener(this, "onClickButton", PDEAgentController.PDE_AGENT_CONTROLLER_EVENT_ACTION_SELECTED);
        mCustomButton3.addListener(this, "onClickButton", PDEAgentController.PDE_AGENT_CONTROLLER_EVENT_ACTION_SELECTED);
        ...
        if(event.getType().equals(PDEAgentController.PDE_AGENT_CONTROLLER_EVENT_ACTION_SELECTED)){
            if (sender == mDefaultButton1){
                ...
                PDEDialog.constructDialog("LOGIN_FAILED_TARPIT_TIME")
                        ...
                        .setMessageFormatParameters(PDEUtils.loadStringFromResources("LOGIN_UNAVAILABLE_TARPIT_TIME_message_parameter"))
                        // set standard android click listener for first dialog button
                        .setOnClickListenerButton1(new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                ...
                PDEDialog.constructDialog("APP_UPDATE_REQUIRED")
                        ...
                        .setMessageFormatParameters(PDEUtils.loadStringFromResources("APP_UPDATE_REQUIRED_message_parameter1"),
                ...
                PDEDialog.constructDialog()
                        ...
                        .setTitleCustom(PDEUtils.loadStringFromResources("Custom_Example_1_title"))
                        // set also just one button
                        .setButton1TextCustom(PDEUtils.loadStringFromResources("Custom_Example_1_button1_label"))
                         // set standard android click listener for first dialog button
                        .setOnClickListenerButton1(new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                ...
                PDEDialog.constructDialog(PDEUtils.loadStringFromResources("Custom_Example_2_title"),
                                         PDEUtils.loadStringFromResources("Custom_Example_2_message"),
                                         PDEUtils.loadStringFromResources("Custom_Example_2_button1_label"),
                                         PDEUtils.loadStringFromResources("Custom_Example_2_button2_label")
                )
                        // deliver current style
                        .setStyleCustom(mStyle)
                        // set standard android click listener for first dialog button
                ...
                // Create dialog & deliver all texts and labels
                PDEDialog.constructDialog(PDEUtils.loadStringFromResources("Custom_Example_3_title"),
                                          PDEUtils.loadStringFromResources("Custom_Example_3_message"),
                                          PDEUtils.loadStringFromResources("Custom_Example_3_button1_label")
                )
                        // deliver current style
                        .setStyleCustom(mStyle)
