...
//----------------------------------------------------------------------------------------------------------------------
// PDEListPlainIconSingleLineAdapter
//----------------------------------------------------------------------------------------------------------------------
...
/**
 * @brief Example of an adapter for a list item that consists of a PDEIcon and a single line of text.
 *
 ...
 */
public class PDEListPlainIconSingleLineAdapter extends PDEListBaseAdapter {
     ...
     */
    public PDEListPlainIconSingleLineAdapter(Context context, int layoutTemplateResourceID, int[] targetViewIDs){
