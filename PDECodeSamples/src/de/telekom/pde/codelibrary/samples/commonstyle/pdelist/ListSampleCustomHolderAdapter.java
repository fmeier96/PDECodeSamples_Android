...
//-----  properties ---------------------------------------------------------------------------------------------------
    ...
    protected void fillListItem(PDEListItem listItem) {
        ...
        holder.titleView.setText((mListData.get(position)).getTitle());
        ...
        holder.iconView.setImageResource((mListData.get(position)).getIconResource());
    }
