...
public class ActivityListMultipleSelection extends PDESherlockListActivity
{

	private final String[]			items				= new String[] { "item 1", "item 2", "item 3", "item 4", "item 5",
			"item 6", "item 7", "item 8", "item 9", "item 10", "item 11", "item 12", "item 13", "item 14", "item 15",
			"item 16", "item 17", "item 18", "item 19", "item 20" };

	private final PDEActionModeHelper actionModeCallback	= new PDEActionModeHelper(this)
													{
	...
	private class MyArrayAdapter extends ArrayAdapter<String>
	{
		...
		public View getView(int position, View convertView, android.view.ViewGroup parent)
		{
			...
			if (getListView().getCheckedItemPositions()!=null && getListView().getCheckedItemPositions().get(position))
			{
