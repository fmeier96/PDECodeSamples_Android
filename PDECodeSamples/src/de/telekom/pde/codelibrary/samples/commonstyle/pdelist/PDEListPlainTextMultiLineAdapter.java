...
//----------------------------------------------------------------------------------------------------------------------
// PDEListPlainTextMultiLineAdapter
//----------------------------------------------------------------------------------------------------------------------
...
/**
 * @brief Example of an adapter for a multi line text list item.
 *
 ...
 */
public class PDEListPlainTextMultiLineAdapter extends PDEListBaseAdapter {
     ...
     */
    public PDEListPlainTextMultiLineAdapter(Context context, int layoutTemplateResourceID, int[] targetViewIDs){
    ...
    protected void fillListItem(PDEListItem listItem){
        ...
        listItem.setTargetViewContent(R.id.PDEList_ItemMainText, String.format(Locale.US,text+" (%d)", position));
