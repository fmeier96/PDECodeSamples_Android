...
//----------------------------------------------------------------------------------------------------------------------
//  UsageBarSmallColorsActivity
//----------------------------------------------------------------------------------------------------------------------


/**
 * @brief UsageBarSmallColorsActivity for some overview of different colored usage bars.
 */
public class UsageBarSmallColorsActivity extends PDEActionBarActivity {
    ...
    private final static String LOG_TAG = UsageBarSmallColorsActivity.class.getName();
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        // set content view
        setContentView(R.layout.usagebar_small_colors_screen);
        ...
        mEmptyButton.addListener(this, "onEmptyButtonClicked", PDEAgentController.PDE_AGENT_CONTROLLER_EVENT_ACTION_SELECTED);
        mFillButton.addListener(this, "onFillButtonClicked", PDEAgentController.PDE_AGENT_CONTROLLER_EVENT_ACTION_SELECTED);
    }


    /**
     * @brief Callback function to empty all usage bars
    ...
    /**
     * @brief Callback function to fill all usage bars
     * @param event Received event
     */
    @SuppressWarnings("unused")
