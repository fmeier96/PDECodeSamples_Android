...
//----------------------------------------------------------------------------------------------------------------------
//  UsageBarFullColorsActivity
//----------------------------------------------------------------------------------------------------------------------


/**
 * @brief UsageBarFullColorsActivity for some overview of different colored usage bars.
 */
public class UsageBarFullColorsActivity extends PDEActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        // set content view
        setContentView(R.layout.usagebar_full_colors_screen);
