...
public class MyStandardCheckBoxListTestActivity extends PDEActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        // set content view
        setContentView(R.layout.standard_list_activity);

        // get pde list view
        final ListView list = (ListView) findViewById(R.id.standard_list);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                // show selected item
                Toast.makeText(MyStandardCheckBoxListTestActivity.this, "Selected : " + element.getTitle(),
