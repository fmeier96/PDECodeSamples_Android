...
public class ButtonSelectorActivity extends PDEActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBackgroundTypeAdapter = new ArrayAdapter<ButtonType>(this,
                ...
                new ButtonType("Haptic", PDEButton.PDEButtonLayerType.BackgroundHaptic),
        ...
        mTelekomButton.setTitle( (mContentAdapter.getItem(mSelectedSpinnerIndexes[1])).mButtonTitle );
