 ...
 */
public class ButtonShowcase2Activity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonCheckbox1.setTag(new Integer(0));
        ...
        mButtonCheckbox2.setTag(new Integer(1));
        ...
        mButtonRadio1.setTag(new Integer(0));
        ...
        mButtonRadio2.setTag(new Integer(1));
        ...
        mButtonCheckbox3.setAlignment(PDEConstants.PDEAlignment.PDEAlignmentCenter);
        ...
        mButtonCheckbox4.setAlignment(PDEConstants.PDEAlignment.PDEAlignmentCenter);
        ...
        mButtonCheckbox5.setAlignment(PDEConstants.PDEAlignment.PDEAlignmentCenter);
        ...
        mButtonCheckbox6.setAlignment(PDEConstants.PDEAlignment.PDEAlignmentCenter);
