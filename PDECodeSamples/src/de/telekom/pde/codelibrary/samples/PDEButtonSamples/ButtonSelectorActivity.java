...
public class ButtonSelectorActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonEventListAdapter = new ArrayAdapter<String>(this, R.layout.buttonselector_eventlistitem, mButtonEvents);
    ...
    public void onButtonChange(ButtonType buttonType, ButtonContent buttonContent, ButtonColor buttonColor){
        ...
        if(buttonType.mName == "Embossed"){
            LinearLayout.LayoutParams lp=(LinearLayout.LayoutParams)mTelekomButton.getLayoutParams();
            lp.width = mDefaultWidth+ PDEBuildingUnits.BU();
            lp.height = mDefaultHeight+ PDEBuildingUnits.BU();
            lp.topMargin = mDefaultMarginTop - PDEBuildingUnits.oneHalfBU();
            lp.bottomMargin = mDefaultMarginBottom - PDEBuildingUnits.oneHalfBU();
            lp.leftMargin = mDefaultMarginLeft - PDEBuildingUnits.oneHalfBU();
            lp.rightMargin = mDefaultMarginRight - PDEBuildingUnits.oneHalfBU();
            mTelekomButton.setLayoutParams(lp);
        } else {
            LinearLayout.LayoutParams lp=(LinearLayout.LayoutParams)mTelekomButton.getLayoutParams();
            lp.width = mDefaultWidth;
            lp.height = mDefaultHeight;
            lp.topMargin = mDefaultMarginTop;
            lp.bottomMargin = mDefaultMarginBottom;
            lp.leftMargin = mDefaultMarginLeft;
            lp.rightMargin = mDefaultMarginRight;
            mTelekomButton.setLayoutParams(lp);
        }
