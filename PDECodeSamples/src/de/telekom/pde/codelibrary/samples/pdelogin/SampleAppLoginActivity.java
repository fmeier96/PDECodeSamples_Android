 ...
 * user input can be implemented with the PDEInputField, the algorithm for the email check is sophisticated enought to
...
public class SampleAppLoginActivity extends PDEBaseLoginScreenActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.LoginScreenUsernameLabel)).setText(getResources().getString(R.string.sampleapp_login_username_label));
    ...
    public void loginButtonClicked(final String email, final String password, final boolean staySignedIn) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(SampleAppLoginActivity.this, "login button clicked email: "+email+"\n password: "+password+" staySignedIn: "+(staySignedIn?"true":"false"),Toast.LENGTH_SHORT).show();
            }
        });
    }
